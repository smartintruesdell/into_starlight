...
local PATH = "/isl/plugins/monsters/boss"
...
local function isl_handle_death_drop_motes()
...
update_handle_enteringState = Plugins.add_before_hook(
  update_handle_enteringState,
  function(self, next_state)
    if next_state == "dieState" then
      isl_handle_death_drop_motes()
    end
