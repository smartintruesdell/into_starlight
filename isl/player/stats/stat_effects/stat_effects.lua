...
ISLStatEffectsController = createClass("ISLStatEffects")

ISLStatEffectsController.effect_category_identifier = "isl_stat_based_effects"

-- Constructor ----------------------------------------------------------------

function ISLStatEffectsController:init(entity_id)
...
function ISLStatEffectsController:update(--[[dt: number]])
  if self:update_state() then
    ...
    status.setPersistentEffects(
      ISLStatEffectsController.effect_category_identifier,
      effects_map:spread()
    )
  end
end

function ISLStatEffectsController:update_state()
