--[[
  NOTE FOR MODDERS:
  Don't modify this script. Instead, add your plugins to weapons.plugins.config!
  This way we can all play in the weapon.lua sandbox without wrecking eachothers
  work.
]]
