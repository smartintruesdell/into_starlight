...
**** STARTED Display secondary stats [0/5]

- [-] Vigor
  - [X] Icon (Heart, Red)
  - [ ] Appears on character stats
- [-] Mobility
  - [X] Icon (Arrows, Green)
  - [ ] Appears on character stats
- [ ] Crit Chance
  - [ ] Icon (Blood, darker than heart)
  - [ ] Appears on character stats
- [ ] Celerity
  - [ ] Icon (Watch?)
  - [ ] Appears on character stats
...
**** STARTED Display Perks

***** STARTED Below the character's stats there is a scrollarea with the characters's perks

***** STARTED Each perk has an indicator describing what it does
