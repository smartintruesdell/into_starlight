...
**** TODO Focus increases the player's Max Energy

*** TODO =Vigor=

**** TODO Rename =isl_health= to Vigor
**** TODO Vigor increases the player's Max Health
